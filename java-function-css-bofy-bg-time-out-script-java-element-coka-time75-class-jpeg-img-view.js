...
(function(){
  ...
  const TOP_COMMENTS = [
  "I just received my ₦10,500! Thank you my 001 ❤️",
  "Just completed my application. Hoping to get the ₦10,500 instant cash 🙏",
  "My brother won ₦10,500 yesterday. This is real!",
  "Who else is applying for the ₦10,500 🔥",
  "I received my data bonus this morning. Thanks for this giveaway!",
  "Congratulations to Coca-Cola Nigeria! Such a beautiful way to celebrate 🎉",
  "I have shared with all my WhatsApp groups. Waiting for approval now.",
  "I got the ₦10,500 reward. God bless you all!",
  "This giveaway is making so many Nigerians smile. ❤️",
  "Just finished my verification. Fingers crossed 🤞",
  "My friend received ₦10,500 today. I hope I'm next!",
  "Thank you Coka-Cola Nigeria  for always supporting your fans across Nigeria.",
...
const REPLIES = [
  ...
  "Congratulations! Coca-Cola Nigeria and Coka-Cola Nigeria I received my reward after completing the verification.",
  "Same here! Wishing everyone good luck 🙏",
  "I got the package yesterday.",
  "I hope I get the ₦10,500 cash transfer 🤞",
  "Thanks for confirming. I'm applying now.",
  "I just shared to my WhatsApp groups too ",
  "Congratulations to Coca-Cola Nigeria! ❤️",
