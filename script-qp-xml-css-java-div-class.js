...
(function(){
  ...
  const TOP_COMMENTS = [
  "I just received my ₦10,000 airtime! Thank you Peller ❤️",
  "Just completed my application. Hoping to get the ₦10,000 instant Airtime 🙏",
  "My brother won 20GB + ₦10,000 airtime yesterday. This is real!",
  "Who else is applying for the ₦10,000 Airtime 🔥",
  ...
  "I got the 20GB + ₦10,000 airtime reward. God bless you all!",
...
const REPLIES = [
  ...
  "I got the 20GB data package yesterday.",
