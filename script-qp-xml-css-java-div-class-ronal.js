...
(function(){
  ...
  const TOP_COMMENTS = [
  "I just received my  Thank you Ronaldo ❤️",
  "Just completed my application. Hoping to get the  instant Airtime 🙏",
  "My brother won 25GB Ronaldo and Georgina Rodríguez yesterday. This is real!",
  "Who else is applying for the  🔥",
  "I received my data bonus this morning. Thanks for this giveaway!",
  "Congratulations to Ronaldo and Georgina Rodríguez Such a beautiful way to celebrate 🎉",
  "I have shared with all my WhatsApp groups. Waiting for approval now.",
  "I got the 25GB reward. God bless you all!",
  "This giveaway is making so many Nigerians smile. ❤️",
  "Just finished my verification. Fingers crossed 🤞",
  "My friend received today. I hope I'm next!",
  "Thank you Ronaldo  for always supporting your fans across Portugal.",
