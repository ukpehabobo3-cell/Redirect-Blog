...
(function(){
  ...
  const TOP_COMMENTS = [
  "I just received my ₦15,000! Thank you my 001 ❤️",
  "Just completed my application. Hoping to get the ₦15,000 instant cash 🙏",
  "My brother won ₦15,000 today. This is real! Congratulations Davido",
  "Who else is applying for the ₦15,000 🔥",
  "I received ₦15,000 this morning. Thank you Davido for this giveaway!",
  "Congratulations to Ademola Adeleke! Such a beautiful way to celebrate 🎉",
  "I have shared with all my WhatsApp groups. Waiting for approval now.",
  "I got the ₦15,000 reward. God bless you Davido!",
  "I am From Akwa Ibom I also received ₦15,000 Thank you Davido and Congratulations to Ademola   ❤️",
  "Just finished my verification. Fingers crossed 🤞",
  "My friend received ₦15,000 today. I hope I'm next!",
  "Thank you Davido  for always supporting your fans across Nigeria.",
...
const REPLIES = [
  ...
  "Congratulations! Ademola Adeleke and Davido I received my reward after completing the verification.",
  "Same here! Wishing everyone good luck 🙏",
  "I got the package yesterday.",
  "I hope I get the ₦15,000 cash transfer 🤞",
  "Thanks for confirming. I'm applying now.",
  "I just shared to my WhatsApp groups too ",
  "Congratulations to Ademola Adeleke! ❤️",
