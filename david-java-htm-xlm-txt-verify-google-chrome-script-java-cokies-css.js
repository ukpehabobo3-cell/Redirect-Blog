...
(function(){
  ...
  const TOP_COMMENTS = [
  "I just received my ₦10,000! Thank you my 001 ❤️",
  "Just completed my application. Hoping to get the ₦10,000 instant cash 🙏",
  "My brother won ₦10,000 yesterday. This is real!",
  "Who else is applying for the ₦10,000 🔥",
...
const REPLIES = [
  ...
  "I hope I get the ₦10,000 cash transfer 🤞",
