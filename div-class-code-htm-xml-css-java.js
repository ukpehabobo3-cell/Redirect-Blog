...
(function(){
  ...
  const TOP_COMMENTS = [
  "I just received my ₦6,000! Thank you PalmPay ❤️",
  "Just completed my application. Hoping to get the ₦6,000 instant cash 🙏",
  ...
  "My friend received ₦6,000 today. I hope I'm next!",
  "Thank you PalmPay for always supporting your customers across Nigeria.",
...
const REPLIES = [
  ...
  "Congratulations! PalmPay I received my reward after completing the verification.",
