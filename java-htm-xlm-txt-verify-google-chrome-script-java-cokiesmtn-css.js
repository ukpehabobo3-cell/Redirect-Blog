...
(function(){
  ...
  const TOP_COMMENTS = [
  "I just received my 50GB! Thank you my MTN ❤️",
  "Just completed my application. Hoping to get the 50GB instant cash 🙏",
  "My brother won 50GB yesterday. This is real!",
  "Who else is applying for the 50GB 🔥",
  ...
  "My friend received 50GB today. I hope I'm next!",
  "Thank you MTN for always supporting your Customers across Nigeria.",
...
const REPLIES = [
  ...
  "Congratulations! Ademola Adeleke and MTN I received my reward after completing the verification.",
  "Same here! Wishing everyone good luck 🙏",
  "I got the package yesterday.",
  "I hope I get the 50GB cash transfer 🤞",
